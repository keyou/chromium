...
HTMLScrollerElement::HTMLScrollerElement(Document& document)
    : HTMLElement(html_names::kScrollerTag, document) {}

void HTMLScrollerElement::CollectStyleForPresentationAttribute(
